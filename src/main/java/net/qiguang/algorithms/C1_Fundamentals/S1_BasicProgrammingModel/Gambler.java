...
public class Gambler {
    ...
    public static void main(String[] args) {
        int stake = 10;//Integer.parseInt(args[0]);    // gambler's stating bankroll
        int goal = 20;//Integer.parseInt(args[1]);    // gambler's desired bankroll
        int trials = 1000;//Integer.parseInt(args[2]);    // number of trials to perform
